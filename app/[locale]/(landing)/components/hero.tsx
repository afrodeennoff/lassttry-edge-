    ...
    <section ref={ref} className="relative pt-48 pb-32 px-6 overflow-hidden min-h-screen flex flex-col justify-center items-center text-center">
      ...
      >
        ...
        >
          <Link
            href="/dashboard"
            className="group relative w-full sm:w-auto bg-white text-black px-10 py-4 rounded-full font-bold text-xs uppercase tracking-[0.2em] transition-all hover:bg-teal-400 hover:shadow-[0_0_40px_-10px_rgba(45,212,191,0.6)] text-center"
          >
            Apply for Access
          </Link>
          ...
          <Link 
            href="/updates"
            className="text-zinc-500 hover:text-white transition-colors text-xs font-bold uppercase tracking-[0.2em] flex items-center gap-2 group"
          >
             View Documentation 
