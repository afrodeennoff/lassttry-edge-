...
const copy = {
  en: {
    preview: 'Black Friday: 50€ off Qunt Edge Lifetime - Until Nov 30th',
    greeting: 'Hello {firstName},',
    intro:
      "I wanted to reach out personally about a special Black Friday offer for Qunt Edge users.",
    offer:
    ...
    closingLine2: 'The Qunt Edge Team',
    unsubscribe: 'Unsubscribe',
  },
  fr: {
    preview: 'Black Friday : 50€ de réduction sur Qunt Edge Lifetime - Jusqu’au 30 nov.',
    greeting: 'Bonjour {firstName},',
    intro:
      "Je voulais vous écrire personnellement pour vous parler d'une offre Black Friday réservée aux utilisateurs de Qunt Edge.",
    offer:
